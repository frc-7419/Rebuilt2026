...
public class FiducialObservation implements StructSerializable {
    ...
    public static final Struct<FiducialObservation> struct = new FiducialObservationStruct();

    private static class FiducialObservationStruct implements Struct<FiducialObservation> {
        @Override
